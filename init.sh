...
docker service create --name frontend --replicas 1 --publish mode=host,published=80,target=80 --env VUE_APP_API_IP="http://172.17.0.1:8000" dwenup/env-app-frontend:1.0.1